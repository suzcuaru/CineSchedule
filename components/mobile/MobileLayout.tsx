...
export const MobileLayout: React.FC<ReturnType<typeof useAppLogic>> = (props) => {
  const { 
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-[#0b0f19] text-slate-200 font-sans w-full overflow-hidden">
      <Navbar 
        {...props} 
